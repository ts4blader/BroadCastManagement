...
public class DataTable extends VBox {
    ...
    //TableView
    private TableView<Nation> tableView;
    //ID Col
    private TableColumn<Nation, String> idCol;
    //Name Col
    private TableColumn<Nation, String> nameCol;
    //Button Bar
    ...
    public TableColumn<Nation, String> getTextCol(String text, String property) {

        TableColumn<Nation, String> tableColumn;
    ...
    public TableView<Nation> getTableView() {

        TableView<Nation> tableView = new TableView<>();

        tableView.setItems(NationBLL.getAllNation());
        ...
        tableView.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<Nation>() {
            @Override
            public void changed(ObservableValue<? extends Nation> observable, Nation oldValue, Nation newValue) {
                if(tableView.getSelectionModel().getSelectedItem() != null){
                    InputField.setNationFromTable(newValue);
                }
            }
        });
